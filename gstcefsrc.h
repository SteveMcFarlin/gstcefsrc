...
struct _GstCefSrc {
  ...
  guint channel_layout;
  guint audio_rate;
  guint frames_per_buffer;
...
struct _GstCefSrcClass {
  ...
  void (*call)(GstCefSrc *cefsrc, const gchar *name, const gchar *js,
               gpointer user_data);
  void (*expose_function)(GstCefSrc *cefsrc, const gchar *name,
                          gpointer user_data);
  void (*execute_js)(GstCefSrc *cefsrc, const gchar *name, gpointer user_data);
};
